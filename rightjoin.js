...
Right Join is reverse of LEFT JOIN. Right Join query returns all the records from all records from right table and matching records from the left table. 
Select column_name FROM table1 RIGHT JOIN table2 ON table1.coulmn_name=table2.column_name


SELECT dept.DeptID, dept.DepartmentName,emp.EmpID,emp.FirstName FROM Employee emp RIGHT JOIN Department dept ON emp.DeptID = dept.DeptID;
